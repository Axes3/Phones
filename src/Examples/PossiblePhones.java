 ...
 *         &lt;element name="Tablet" type="{}Product" maxOccurs="unbounded"/>
 *         &lt;element name="Phone" type="{}Product" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PossiblePhones {
    ...
    protected List<Product> tablet;
    @XmlElement(name = "Phone", required = true)
    protected List<Product> phone;
     ...
     * 
     */
    public List<Product> getTablet() {
        if (tablet == null) {
            tablet = new ArrayList<Product>();
        }
        return this.tablet;
    }
